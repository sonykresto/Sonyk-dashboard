...
function KPICard({ label, value, sub, delta, accent, trendData, sparkId }) {
    ...
    <div className="min-h-full w-full bg-[#f7f8fa] p-6 md:p-8 overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 text-center">
          <p className="text-sm font-extrabold tracking-tight" style={{ color: BLUE }}>SONYK</p>
          <p className="text-xs text-gray-400 mt-1">Votre réputation automatisée</p>
          <p className="text-xs text-gray-400 mt-2">contact@sonyk.ca · sonyk.ca</p>
        </div>
